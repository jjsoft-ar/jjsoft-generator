...
class BaseCommand extends Command
{
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('jjsoft.jjsoft_generator.path.schema_files', base_path('resources/model_schemas/'));
    ...
    public function getOptions()
    {
        return [
            ...
            ['connectionName', null, InputOption::VALUE_REQUIRED, 'Specify Connection name for multiple database'],
            ['moduleName', null, InputOption::VALUE_REQUIRED, 'Module name of sky pinpong component'],
        ];
    }
