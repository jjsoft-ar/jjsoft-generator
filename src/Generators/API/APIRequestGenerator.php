...
class APIRequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = TemplateUtil::getTemplate('api.request.create_request', 'jjsoft-generator');
    ...
    {
        $templateData = TemplateUtil::getTemplate('api.request.update_request', 'jjsoft-generator');
