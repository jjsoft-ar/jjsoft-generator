...
class ControllerGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        if ($this->commandData->getAddOn('datatables')) {
            $templateData = TemplateUtil::getTemplate('scaffold.controller.datatable_controller', 'jjsoft-generator');

            $this->generateDataTable();
        } else {
            $templateData = TemplateUtil::getTemplate('scaffold.controller.controller', 'jjsoft-generator');
    ...
    {
        $templateData = TemplateUtil::getTemplate('scaffold.datatable', 'jjsoft-generator');
