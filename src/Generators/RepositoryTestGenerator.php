...
class RepositoryTestGenerator extends BaseGenerator
{
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = config('jjsoft.jjsoft_generator.path.repository_test', base_path('tests/'));
        $this->fileName = $this->commandData->modelName.'RepositoryTest.php';
    }

    public function generate()
    {
        $templateData = TemplateUtil::getTemplate('test.repository_test', 'jjsoft-generator');
