...
class RequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = TemplateUtil::getTemplate('scaffold.request.create_request', 'jjsoft-generator');
    ...
    {
        $templateData = TemplateUtil::getTemplate('scaffold.request.update_request', 'jjsoft-generator');
