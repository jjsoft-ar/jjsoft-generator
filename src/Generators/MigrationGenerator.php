...
use JJSoft\Generator\Utils\SchemaUtil;
...
class MigrationGenerator extends BaseGenerator
{
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = config('jjsoft.jjsoft_generator.path.migration', base_path('database/migrations/'));
    }

    public function generate()
    {
        $templateData = TemplateUtil::getTemplate('migration', 'jjsoft-generator');
