...
use JJSoft\Generator\Utils\TableFieldsGenerator;
...
class ModelGenerator extends BaseGenerator
{
    ...
    {
        $templateData = TemplateUtil::getTemplate('model', 'jjsoft-generator');
    ...
    private function fillSoftDeletes($templateData)
    {
        if (!$this->commandData->getOption('softDelete')) {
            ...
            $deletedAtTimestamp = config('jjsoft.jjsoft_generator.timestamps.deleted_at', 'deleted_at');
            $templateData = str_replace(
    ...
    private function fillDocs($templateData)
    {
        if ($this->commandData->getAddOn('swagger')) {
            ...
            $docsTemplate = TemplateUtil::getTemplate('docs.model', 'jjsoft-generator');
