...
use JJSoft\Generator\Utils\GeneratorFieldsInputUtil;
...
class CommandData
{
    ...
    /** @var string */
    public $connectionName, $modelName, $commandType, $moduleName;
    ...
    private function getInputFromTable()
    {
        ...
        $this->inputFields = TableFieldsGenerator::generateFieldsFromTable($tableName,$connectionName);
        $this->checkForDiffPrimaryKey();
    }
}
